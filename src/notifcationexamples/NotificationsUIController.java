...
public class NotificationsUIController implements Initializable, Notifiable {
    ...
    public void startTask1(ActionEvent event) {
        if (task1 == null) {
            ...
            task1.start();
            setNotifyArea("Task 1 running... ");
            task1Button.setText("Stop 1");
        } else {
    ...
    public void startTask2(ActionEvent event) {
        if (task2 == null) {
            ...
            task2.start();
            setNotifyArea("Task 2 running... ");
            task2Button.setText("Stop 2");
        } else {
    ...
    public void startTask3(ActionEvent event) {
        if (task3 == null) {
            ...
            task3.start();
            setNotifyArea("Task 3 running... ");
            task3Button.setText("Stop 3");
        } else {
    ...
    public void setNotifyArea(String message){        
        notifyArea.setText(message);
    }
}
